        ...
        public override FaceData GetFace(Faces face)
        {
            ...
            switch (face)
            {
                ...
                case Faces.TOP:
                    return new FaceData(
                        [
                    new TexturedVertex(new Vector3(-0.5f, +0.5f, -0.5f), UVTop[0]).SetColorM(new Vector3(0.48627f, 0.74117f, 0.4196f)), // topleft vert
                            new TexturedVertex(new Vector3(+0.5f, +0.5f, -0.5f), UVTop[1]).SetColorM(new Vector3(0.48627f, 0.74117f, 0.4196f)), // topright vert
                            new TexturedVertex(new Vector3(+0.5f, +0.5f, +0.5f), UVTop[2]).SetColorM(new Vector3(0.48627f, 0.74117f, 0.4196f)), // bottomright vert
                            new TexturedVertex(new Vector3(-0.5f, +0.5f, +0.5f), UVTop[3]).SetColorM(new Vector3(0.48627f, 0.74117f, 0.4196f)), // bottomleft vert
                        ]);
